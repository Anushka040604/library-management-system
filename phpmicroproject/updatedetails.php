...
<label>Book Id</label>
<input type="text" name="bid" class="binfo" value="<?php echo $result['bid']?>">
</div>
<div class="input_field">
<label>Book Name</label>
<input type="text" name="bname" class="binfo" value="<?php echo $result['bname']?>">
</div>
<div class="input_field">
<label>Author Name</label>
<input type="text" name="auname" class="binfo" value="<?php echo $result['bauthor']?>">
</div>
<div class="input_field">
<label>Price</label>
<input type="number" name="price" class="binfo" value="<?php echo $result['bprice']?>">
</div>
<div class="input_field">
<label>Book Issue Date</label>
<input type="Date" name="issuebook" class="binfo" value="<?php echo $result['bidate']?>">
</div>
<div class="input_field">
<label>Book Return Date</label>
<input type="Date" name="retbook" class="binfo" value="<?php echo $result['brdate']?>">
</div>
<div class="input_field">
